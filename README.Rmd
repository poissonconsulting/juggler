...
When presented with new code the first job is to use `jg_check` to see if the code has any problems which may be fixable using jg_fix or may require manually editing. 
